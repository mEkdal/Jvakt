...
class DBupdate {
	...
	DBupdate(int sessnum) throws Exception {
		...
		//        System.out.println("New DBupdate sessnum: " + sessnum);
...
//				conn = DriverManager.getConnection(DBUrl,"Jvakt","xz");
			...
			while (rs.next() && swLoop) {
				...
				//		 System.out.println("Row sess " + sessnum  );
				System.out.println("sType 1 " + sType );
//				if ( m.getType().equalsIgnoreCase("A")) { swDormant = false; break; }  
...
//			if ( m.getType().equalsIgnoreCase("I") || m.getType().equalsIgnoreCase("D") ) {   
...
//				if ( m.getType().equalsIgnoreCase("I")) {
			...
			System.out.println("DT SQLexeption session " + sessnum );
			...
			System.out.println("DT exeptionerror session " + sessnum );
			System.err.println(e);
			System.err.println(e.getMessage());
		}
		finally { System.out.println("DT finally  " + sessnum ); }
